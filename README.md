...
**Язык интерфейса:** русский и английский (переключается в настройках, вкладка «Общие»).
**Лицензия:** MIT.
...
Все три переназначаются в настройках, вкладка «Управление» (изменения
применяются после перезапуска). Первые два необязательны и могут быть сняты
полностью; хоткей режима редактирования обязателен.
